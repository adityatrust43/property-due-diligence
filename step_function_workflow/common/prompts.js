...
\`\`\`
ABSOLUTELY CRITICAL: Your entire response MUST be a single, valid JSON array. Do not include any introductory text, markdown formatting, code block markers, or any text whatsoever before the opening brace or after the closing brace. Your response must be immediately parsable by JSON.parse().
`;
