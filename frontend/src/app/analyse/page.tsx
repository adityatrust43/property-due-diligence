            ...
            if (analysisResult.titleChainEvents && analysisResult.titleChainEvents.length > 0) {
                ...
                analysisResult.titleChainEvents
                  ...
                  .forEach(event => {
                    ...
                    printWindow.document.write(`<p style="font-size: 0.9em; color: #555;">`);
    ...
    <div className="min-h-screen bg-slate-100 text-slate-800 flex flex-col items-center p-4 sm:p-8">
      <header className="w-full max-w-5xl mb-10 text-center">
        <div className="flex items-center justify-center mb-2">
          ...
          <h1 className="text-4xl font-bold text-blue-700 tracking-tight">Property Document Analyzer</h1>
        </div>
      ...
      <main className="w-full max-w-5xl bg-white shadow-xl rounded-xl p-6 sm:p-10">
        <section id="file-upload-section" className="mb-8">
          <h2 className="text-2xl font-semibold text-gray-700 mb-2 text-center">Upload Document(s)</h2>
        ...
        {selectedFiles.length > 0 && (
          <div className="text-center mb-8">
            <button
              ...
              className="px-8 py-3 bg-blue-600 text-white font-semibold rounded-lg shadow-md hover:bg-blue-700 transition-colors disabled:bg-gray-400 disabled:cursor-not-allowed focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50"
              aria-live="polite"
            >
        ...
        {isLoading && (loadingMessage.startsWith("Initiating") || loadingMessage.includes("Extracting") || loadingMessage.includes("Sending") || loadingMessage.includes("Parsing") || loadingMessage.includes("Loading preview")) && (
          <div className="my-10 flex flex-col items-center justify-center">
            <LoadingSpinner />
            <p className="text-sm text-slate-600 mt-2 text-center">{loadingMessage}</p>
          </div>
        )}
          ...
          <div className="my-8">
            <div className="flex flex-col sm:flex-row justify-between sm:items-center mb-6">
                <div className="mb-4 sm:mb-0">
                    <h2 className="text-3xl font-semibold text-blue-700">Analysis Report</h2>
                ...
                <button
                    ...
                    className="flex items-center self-start sm:self-center px-4 py-2 bg-green-600 text-white font-medium rounded-lg shadow hover:bg-green-700 transition-colors focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-opacity-50 noprint"
                >
